/*
 * \file Product_log_thread.java
 * \author IBIS Ibrahim
 * \date 30 avril 2017
 *
 * Thread permettant de generer les logs pour le producteur
 *
 */
...
class Product_log_thread extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            String nom;
            if (type == 0) nom = "productor";
            else if (type == 1) nom = "productargent";
            else nom = "productbronze";
            r = c.getAmountRess();
            writer.append("\n{ t: '" + iteration + "', or: '" + r[0] + "', argent: '" + r[1] + "', bronze: '" + r[2] + "'}");
            writer.flush();
